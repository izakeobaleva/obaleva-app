...
const SejaMotorista = () => {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ background: 'white', borderRadius: '16px', padding: '16px' }}>
          <div style={{ marginBottom: '16px' }}>
            <label style={{ display: 'block', marginBottom: '6px', fontWeight: 'bold' }}>👤 Nome</label>
          ...
          <div style={{ marginBottom: '16px' }}>
            <label style={{ display: 'block', marginBottom: '6px', fontWeight: 'bold' }}>📅 Data nascimento</label>
          ...
          <div style={{ marginBottom: '16px' }}>
            <label style={{ display: 'block', marginBottom: '6px', fontWeight: 'bold' }}>📄 CNH</label>
      ...
      <div style={{ padding: '16px', paddingBottom: '20px', background: '#f5f5f5' }}>
