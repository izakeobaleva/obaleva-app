    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0F0B1A] to-[#1A1528] flex items-center justify-center p-4">
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="relative z-10 w-full max-w-sm">
        <div className="bg-[#1A1528] rounded-3xl border border-white/10 shadow-xl p-8 text-center">
          ...
          <p className="text-[#A0A0B0] text-sm mb-6">Para receber alertas importantes como:</p>

          <ul className="text-left text-[#A0A0B0] text-sm space-y-2 mb-8 bg-[#0F0B1A] rounded-2xl p-4 border border-white/10">
