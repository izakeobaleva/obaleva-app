    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0F0B1A] to-[#1A1528] pb-24">
      <header className="sticky top-0 z-20 bg-[#1A1528]/80 backdrop-blur-lg border-b border-white/10 px-6 py-4">
        <div className="flex items-center gap-3">
          <button
            onClick={() => navigate('/')}
            className="px-3 py-2 rounded-2xl border border-white/10 text-white hover:bg-white/5 transition-all"
          >
            <ArrowLeft size={20} />
          </button>
      ...
      <main className="p-4 max-w-lg mx-auto mt-4 space-y-4">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="px-3 py-2 rounded-2xl border border-white/10 text-white hover:bg-white/5 transition-all">
              <Phone size={18} />
            </button>
          </div>
        </motion.div>
