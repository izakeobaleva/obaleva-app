...
import { Car, Chrome, Eye, EyeOff, LogOut, Home, Search, User, Menu, MapPin } from 'lucide-react';
...
const HomeScreen = ({ user }: any) => {
  ...
  return (
    <div className="max-w-md mx-auto px-4 pb-28">
      ...
      <div className="h-[200px] rounded-xl bg-[#1A1528] flex items-center justify-center mb-3">
        <div className="text-center">
          <MapPin size={32} className="text-[#F4D03F] mx-auto mb-2" />
          <p className="text-white text-sm">🗺️ Mapa será carregado</p>
          <p className="text-gray-500 text-xs mt-1">Logado: {user?.email}</p>
        </div>
      </div>
  ...
  <div className="max-w-md mx-auto px-4 pb-28 mt-8">
    <div className="bg-[#1A1528] rounded-2xl p-6 text-center border border-[#F4D03F]/20">
      ...
      <button 
        ...
        className="mt-6 w-full py-3 rounded-xl bg-red-500 text-white font-bold"
      >
        SAIR
      </button>
    </div>
