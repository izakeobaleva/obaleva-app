...
// ============================================
// MODAL DE CRIAÇÃO DE CONTA (COM NOME, E-MAIL E TELEFONE OPCIONAL)
// ============================================
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                className="w-full p-2 rounded-xl bg-white/10 border border-white/15 text-white pr-7 text-sm"
                value={password}
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-2 rounded-xl bg-[#F4D03F] text-black font-bold text-sm"
            >
            ...
            <div className="relative my-1.5">
              ...
              <div className="relative flex justify-center">
                <span className="bg-[#1A1528] px-2 text-[10px] text-gray-400">ou</span>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full py-2 rounded-xl bg-white/10 border border-white/20 text-white flex items-center justify-center gap-2 text-sm"
            >
