        ...
        {!user ? (
          ...
          <div className="space-y-3">
            <div className="flex gap-3">
              <button onClick={() => setShowCadastroTipo('passageiro')} className="flex-1 py-3 rounded-xl border border-[#F4D03F]/30 text-white bg-white/5 text-sm font-medium hover:bg-white/10 transition">
                {showCadastroTipo === 'passageiro' ? '▼' : ''} Passageiro
              </button>
              <button onClick={() => setShowCadastroTipo('motorista')} className="flex-1 py-3 rounded-xl border border-[#F4D03F]/30 text-white bg-white/5 text-sm font-medium hover:bg-white/10 transition">
                {showCadastroTipo === 'motorista' ? '▼' : ''} Motorista
              </button>
            </div>
