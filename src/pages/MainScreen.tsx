...
// ============================================
// TELA DE LOCALIZAÇÃO (ÍCONE ANTES DO TÍTULO, COMPACTA)
// ============================================
  ...
  <div className="fixed inset-0 bg-black/70 z-50 flex items-end justify-center">
    <div className="bg-[#1A1528] w-full max-w-md rounded-t-2xl border-t border-[#F4D03F]/30">
      ...
      <div className="px-5 pb-4">
        ...
        <p className="text-[#A0A0B0] text-[11px] mb-3">Para o app funcionar bem, precisamos saber onde você está para encontrar motoristas perto de você.</p>
...
// ============================================
// TELA DE NOTIFICAÇÕES (ÍCONE ANTES DO TÍTULO, COMPACTA)
// ============================================
  ...
  <div className="fixed inset-0 bg-black/70 z-50 flex items-end justify-center">
    <div className="bg-[#1A1528] w-full max-w-md rounded-t-2xl border-t border-[#F4D03F]/30">
      ...
      <div className="px-5 pb-4">
        ...
        <p className="text-[#A0A0B0] text-[11px] mb-2">Para receber alertas importantes como:</p>
        <div className="bg-white/5 rounded-lg p-1.5 mb-2 space-y-0.5">
          <p className="text-white text-[10px] flex items-center gap-1">• 🚗 "Motorista a caminho"</p>
          <p className="text-white text-[10px] flex items-center gap-1">• 📍 "Estou chegando!"</p>
          <p className="text-white text-[10px] flex items-center gap-1">• ✅ "Corrida confirmada"</p>
          <p className="text-white text-[10px] flex items-center gap-1">• 💰 "Promoções e descontos"</p>
        </div>
        <div className="space-y-1.5">
...
// ============================================
// MODAL DE CRIAÇÃO DE CONTA (ÍCONE ANTES DO TÍTULO, COMPACTA, SEM TERMOS)
// ============================================
      ...
      <div className="fixed inset-0 bg-black/70 z-50 flex items-end justify-center">
        <div className="bg-[#1A1528] w-full max-w-md rounded-t-2xl border-t border-[#F4D03F]/30">
          ...
          <div className="px-5 pb-4">
            ...
            <div className="space-y-1.5">
              <div className="bg-white/5 rounded-xl border border-white/15"><div className="flex items-center gap-2 px-3 py-1.5"><span className="text-white">📧</span><input type="email" placeholder="E-mail *" className="flex-1 bg-transparent text-white outline-none text-sm" value={email} onChange={(e) => setEmail(e.target.value)} /></div></div>
    ...
    <div className="fixed inset-0 bg-black/70 z-50 flex items-end justify-center">
      <div className="bg-[#1A1528] w-full max-w-md rounded-t-2xl border-t border-[#F4D03F]/30">
        ...
        <div className="px-5 pb-4">
          ...
          <div className="space-y-1.5">
            <div className="bg-white/5 rounded-xl border border-white/15"><div className="flex items-center gap-2 px-3 py-1.5"><span className="text-white">👤</span><input type="text" placeholder="Nome completo *" className="flex-1 bg-transparent text-white outline-none text-sm" value={nome} onChange={(e) => setNome(e.target.value)} /></div></div>
            <div className="bg-white/5 rounded-xl border border-white/15"><div className="flex items-center gap-2 px-3 py-1.5"><span className="text-white">📧</span><input type="email" placeholder="E-mail *" className="flex-1 bg-transparent text-white outline-none text-sm" value={email} onChange={(e) => setEmail(e.target.value)} /></div></div>
            ...
            <div className="flex gap-1.5"><div className="flex-1 relative"><input type={showPassword ? 'text' : 'password'} placeholder="Senha *" className="w-full py-1.5 px-3 rounded-xl bg-white/10 border border-white/15 text-white pr-7 text-sm" value={password} onChange={(e) => setPassword(e.target.value)} /><button onClick={() => setShowPassword(!showPassword)} className="absolute right-2 top-1.5 text-gray-400">{showPassword ? <EyeOff size={14} /> : <Eye size={14} />}</button></div><div className="flex-1 relative"><input type={showConfirmPassword ? 'text' : 'password'} placeholder="Confirmar *" className="w-full py-1.5 px-3 rounded-xl bg-white/10 border border-white/15 text-white pr-7 text-sm" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} /><button onClick={() => setShowConfirmPassword(!showConfirmPassword)} className="absolute right-2 top-1.5 text-gray-400">{showConfirmPassword ? <EyeOff size={14} /> : <Eye size={14} />}</button></div></div>
