      ...
      <div className="bg-[#1A1528] w-full max-w-md rounded-t-2xl border-t border-[#F4D03F]/30 max-h-[480px] overflow-y-auto">
        ...
        <div className="px-6 pb-5">
          ...
          <div className="space-y-1.5">
            ...
            <label className="flex items-center gap-1.5 py-1"><input type="checkbox" checked={agreeTerms} onChange={(e) => setAgreeTerms(e.target.checked)} className="w-3 h-3" /><span className="text-[#A0A0B0] text-[9px]">Li e aceito os <span className="text-[#F4D03F]">Termos de Uso</span></span></label>
