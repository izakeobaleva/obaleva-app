...
const HomeScreen = ({ user, onLogout, showFullUI }: any) => {
  ...
  return (
    <div className="max-w-md mx-auto px-4 pb-24">
      ...
      {/* PARTE QUE SÓ APARECE DEPOIS DO ONBOARDING */}
      {showFullUI && (
        <>
...
// ============================================
// MODAL DE NOTIFICAÇÕES (ALINHADO)
// ============================================
...
// ============================================
// MODAL DE CRIAÇÃO DE CONTA (ALINHADO)
// ============================================
const SignUpModal = ({ onSuccess, onClose }: any) => {
        ...
        <div className="bg-[#1A1528] w-full max-w-md rounded-t-2xl border-t border-[#F4D03F]/30">
          ...
          <div className="px-5 pb-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex gap-2">
                <button onClick={handleGoogleLogin} className="flex-1 py-1.5 rounded-xl bg-white/10 border border-white/20 text-white text-sm">🌐 Google</button>
