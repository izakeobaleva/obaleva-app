...
import { 
  ...
  Map, Target, ArrowRight, Clock, Award, Users, Headphones, Wallet
} from 'lucide-react';
...
// ============================================
// COMPONENTE DE ORIGEM E DESTINO
// ============================================
...
const PassengerDashboard = ({ 
  ...
  <div className="space-y-4">
    {/* 1. MAPA COM LOGO */}
    <div className="relative h-[220px] rounded-2xl overflow-hidden shadow-2xl">
      <MapComponent />
      {/* Logo sobreposta no mapa */}
      <div className="absolute inset-0 flex items-center justify-center z-10 pointer-events-none">
        <div className="bg-black/40 backdrop-blur-md rounded-2xl px-6 py-3 border border-[#F4D03F]/30 shadow-xl">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0F0B1A] to-[#1A1528]">
      ...
      <div className="max-w-md mx-auto px-4 pb-32">
        ...
        {/* DISCOVER BAR - ROLAGEM HORIZONTAL */}
        <DiscoverBar />
      </div>
