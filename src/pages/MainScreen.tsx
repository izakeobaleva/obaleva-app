        ...
        <div className="max-w-md mx-auto">
          <div className="flex justify-between items-center mb-6">
            ...
            <button onClick={async () => {
              ...
              localStorage.clear();
              window.location.reload();
            }} className="bg-red-500 text-white px-4 py-2 rounded-lg">SAIR</button>
          </div>
          <div className="bg-[#1A1528] h-[200px] rounded-xl flex items-center justify-center">
            <p className="text-white">🗺️ MAPA<br/>Logado: {user.email}</p>
          </div>
          <div className="bg-[#1A1528] rounded-xl p-4 mt-4">
            <input type="text" placeholder="Para onde vai?" className="w-full p-3 rounded-lg bg-white/10 text-white" />
