  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      <div className="absolute inset-0 w-full h-full">
        <RealMap center={userLocation || undefined} zoom={14} showUserLocation={!!userLocation} />
      </div>
      ...
      <div className="absolute inset-0 flex items-center justify-center p-5">
        <div className="bg-[#1a1a2e] rounded-3xl p-6 w-full max-w-[320px] border border-purple-500/30 shadow-2xl">
          <div className="text-center">
            ...
            <button onClick={() => navigate('/permission-notification')} className="w-full py-3 text-gray-500 font-medium text-sm hover:text-gray-400 transition">
              Agora não
            </button>
          </div>
        </div>
