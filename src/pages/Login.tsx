  ...
  return (
    <div className="login-screen">
      ...
      <motion.div
        ...
        className="login-card relative z-20"
      >
        <div className="text-center mb-8">
          <div className="w-20 h-20 mx-auto mb-4 bg-gradient-to-br from-[#F4D03F] to-amber-500 rounded-2xl flex items-center justify-center shadow-2xl">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16, margin: '24px 0' }}>
          ...
          <span style={{ color: '#A0A0B0', fontSize: 14 }}>ou</span>
          <div style={{ flex: 1, height: 1, background: 'rgba(255,255,255,0.1)' }} />
        </div>

        <button className="google-btn" onClick={handleGoogleLogin}>
          <svg className="w-6 h-6" viewBox="0 0 24 24" style={{ marginRight: 8, verticalAlign: 'middle' }}>
