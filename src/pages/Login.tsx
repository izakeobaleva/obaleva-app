  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0F0B1A] to-[#1A1528] flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        className="relative z-10 bg-[#1A1528] rounded-3xl border border-white/10 shadow-xl w-full max-w-[340px] p-5"
      >
        {/* Header */}
        ...
        <motion.button
          ...
          className="w-full py-[10px] rounded-2xl border-[1.5px] border-white/20 bg-white/5 text-white flex items-center justify-center gap-2 hover:bg-white/10 hover:border-white/30 transition-all font-medium text-sm"
        >
        ...
        <div className="relative overflow-hidden rounded-xl mb-2">
          ...
          <div className="relative flex items-center gap-2.5 px-3 py-[9px]">
        ...
        <motion.button
          whileTap={{ scale: 0.98 }}
          type="submit"
          className="w-full py-[9px] rounded-xl font-bold bg-gradient-to-r from-[#FFD966] to-[#F4D03F] text-[#1E1E2F] hover:shadow-lg transition-all flex items-center justify-center gap-2 text-sm mb-3"
        >
        ...
        <div className="border-t border-white/10 pt-3">
          ...
          <Link
            to="/register"
            className="w-full py-[9px] rounded-xl border border-white/15 text-white flex items-center justify-center gap-2 hover:bg-white/5 hover:border-white/30 transition-all font-medium text-xs mb-1.5"
          >
          ...
          <Link
            to="/register-driver"
            className="w-full py-[9px] rounded-xl border border-white/15 text-white flex items-center justify-center gap-2 hover:bg-white/5 hover:border-white/30 transition-all font-medium text-xs"
          >
            <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="#F4D03F" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
        ...
        <motion.button
          whileTap={{ scale: 0.98 }}
          onClick={handleShare}
          className="w-full mt-3 py-[9px] rounded-xl text-[#A0A0B0] hover:text-white hover:bg-white/5 transition-all flex items-center justify-center gap-2 text-[11px] border border-white/5"
        >
          <Share2 size={12} />
