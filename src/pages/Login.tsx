    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0F0B1A] to-[#1A1528] flex flex-col items-center justify-center px-4 py-6">
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="text-sm text-[#A0A0B0]">Entre com e-mail</span>
          <div className="flex-1 h-px bg-white/10" />
        </div>
        ...
        <motion.form
          ...
          className="space-y-3"
        >
          <div className="flex items-center gap-3 bg-[#1A1528] border border-white/10 rounded-2xl px-4 py-3.5">
          ...
          <motion.button
            ...
            type="submit"
            disabled={loading}
            className="w-full rounded-2xl font-bold bg-gradient-to-r from-[#FFD966] to-[#F4D03F] text-[#1E1E2F] hover:shadow-lg transition-all py-3.5 text-base"
          >
        ...
        >
          ...
          <Link to="/register" className="block w-full rounded-2xl font-semibold bg-transparent border border-white/20 text-white hover:bg-white/5 transition-all py-3.5 text-base text-center flex items-center justify-center gap-2">
            <User size={18} />
            Criar conta como Passageiro
          </Link>
          <Link to="/register-driver" className="block w-full rounded-2xl font-semibold bg-transparent border border-white/20 text-white hover:bg-white/5 transition-all py-3.5 text-base text-center flex items-center justify-center gap-2">
            <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="#F4D03F" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round">
