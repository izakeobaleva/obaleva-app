    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0F0B1A] to-[#1A1528] flex items-center justify-center p-4">
      ...
      >
        ...
        <button
          ...
          className="w-full rounded-2xl border border-white/20 bg-white/5 text-white flex items-center justify-center gap-2 hover:bg-white/10 hover:border-white/30 transition-all font-medium text-[11px] px-2"
        >
        ...
        <div className="relative my-1.5">
          ...
          <div className="relative flex justify-center text-[10px]">
            <span className="bg-[#1A1528] px-2 text-[#A0A0B0]">ou — entre com e-mail —</span>
          </div>
        </div>

        <form onSubmit={handleSubmit} className="space-y-1">
          <div className="flex items-center gap-2 bg-[#1A1528] border border-white/10 rounded-2xl px-2">
            <Mail size={12} className="text-[#F4D03F] shrink-0" />
            <input
              type="email"
              placeholder="Seu e-mail"
              className="w-full bg-transparent text-white placeholder-white/50 focus:outline-none text-[11px] py-0.5"
              value={email}
          ...
          <div className="text-right">
            <Link to="/forgot-password" className="text-[10px] text-[#A0A0B0] hover:text-[#F4D03F] transition">
              Esqueceu a senha?
            </Link>
          </div>
          ...
          <button
            type="submit"
            className="w-full rounded-2xl font-bold bg-gradient-to-r from-[#FFD966] to-[#F4D03F] text-[#1E1E2F] hover:shadow-lg transition-all flex items-center justify-center gap-1 text-[11px] px-2"
          >
        ...
        <div className="border-t border-white/10 pt-1.5 mt-1.5 space-y-1">
          <p className="text-[10px] text-[#A0A0B0] text-center">Ainda não tem conta?</p>
          <Link
            to="/register"
            className="w-full rounded-2xl border border-white/15 text-white flex items-center justify-center gap-1 hover:bg-white/5 hover:border-white/30 transition-all font-medium text-[11px] px-2"
          >
            <User size={12} className="text-[#F4D03F]" />
          ...
          <Link
            ...
            className="w-full rounded-2xl border border-white/15 text-white flex items-center justify-center gap-1 hover:bg-white/5 hover:border-white/30 transition-all font-medium text-[11px] px-2"
          >
            <svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="#F4D03F" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <button
          onClick={handleShare}
          className="w-full mt-1 rounded-2xl text-[#A0A0B0] hover:text-white hover:bg-white/5 transition-all flex items-center justify-center gap-1 text-[11px] border border-white/5 px-2"
        >
          <Share2 size={11} />
