        ...
        >
          <div className="bg-[#1A1528] rounded-3xl border border-white/10 shadow-xl p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div className="bg-[#0F0B1A] border border-white/10 rounded-2xl px-8 py-3.5">
                <input 
                  type="email" 
              ...
              <div className="bg-[#0F0B1A] border border-white/10 rounded-2xl px-8 py-3.5 flex items-center">
                <input 
