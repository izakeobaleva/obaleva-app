    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0F0B1A] to-[#1A1528] flex items-center justify-center p-4">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-1.5">
          <div className="flex items-center gap-3 bg-[#1A1528] border border-white/10 rounded-2xl px-3 py-0.5">
        ...
        <button
          onClick={handleShare}
          className="w-full mt-1.5 rounded-2xl text-[#A0A0B0] hover:text-white hover:bg-white/5 transition-all flex items-center justify-center gap-2 text-xs border border-white/5 py-0.5"
        >
          <Share2 size={12} />
