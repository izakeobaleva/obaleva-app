          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="flex items-center bg-[#0F0B1A] border border-white/10 rounded-2xl px-5 focus-within:ring-2 focus-within:ring-[#F4D03F]">
              ...
              <input
                ...
                placeholder="Senha"
                className="flex-1 py-4 bg-transparent text-white placeholder-white/40 focus:outline-none text-base"
                value={password}
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className="w-full py-4 rounded-2xl font-bold bg-gradient-to-r from-[#FFD966] to-[#F4D03F] text-[#1E1E2F] hover:shadow-lg transition-all disabled:opacity-50 flex items-center justify-center gap-2 text-lg"
            >
