...
export function RegisterPassenger() {
  ...
  return (
    <div className="w-full h-screen bg-gradient-to-br from-[#0F0B1A] to-[#1A1528] overflow-y-auto">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <div className="bg-[#1A1528]/95 backdrop-blur-xl rounded-3xl border border-white/10 shadow-2xl p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="flex items-center gap-3 bg-[#0F0B1A] border border-white/10 rounded-2xl px-5 py-4 focus-within:ring-2 focus-within:ring-[#F4D03F]">
                ...
                <motion.button whileTap={{ scale: 0.98 }} type="submit" disabled={loading} className="w-full py-4 rounded-2xl font-bold bg-gradient-to-r from-[#FFD966] to-[#F4D03F] text-[#1E1E2F] hover:shadow-lg transition-all disabled:opacity-50 flex items-center justify-center gap-2 mt-2 text-base">
