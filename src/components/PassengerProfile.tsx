      ...
      <div className="max-w-md mx-auto px-4 pb-24 pt-4">
          ...
          <div className="text-center mt-4">
            {isEditing ? (
              ...
              <>
                ...
                <div className="inline-flex items-center gap-2 mt-3 px-4 py-1.5 rounded-full bg-[#F4D03F]/20"><span className="text-[#F4D03F] text-xs font-bold">🚶 PASSAGEIRO</span></div>
        ...
        <div className="mt-5">
          ...
          <div className="grid grid-cols-3 gap-2">
            <div className="bg-[#1A1528] rounded-xl p-3 text-center border border-[#F4D03F]/15"><div className="text-2xl font-bold text-white">{estatisticas.total_corridas}</div><p className="text-[#A0A0B0] text-[10px]">Corridas</p></div>
            <div className="bg-[#1A1528] rounded-xl p-3 text-center border border-[#F4D03F]/15"><div className="text-2xl font-bold text-white">{estatisticas.distancia_total.toFixed(0)}</div><p className="text-[#A0A0B0] text-[10px]">km rodados</p></div>
            <div className="bg-[#1A1528] rounded-xl p-3 text-center border border-[#F4D03F]/15"><div className="text-2xl font-bold text-white">R$ {estatisticas.total_gasto.toFixed(0)}</div><p className="text-[#A0A0B0] text-[10px]">Total gasto</p></div>
          </div>
        </div>
        ...
        <div className="mt-5 bg-[#1A1528] rounded-xl border border-[#F4D03F]/15 overflow-hidden">
          ...
          <button onClick={() => setIsEditing(true)} className="w-full flex items-center justify-between p-3.5 hover:bg-white/5 transition border-b border-white/10"><div className="flex items-center gap-3"><Edit size={18} className="text-[#F4D03F]" /><span className="text-white text-sm">Editar perfil</span></div><ChevronRight size={16} className="text-gray-500" /></button>
