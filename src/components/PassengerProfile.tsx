      ...
      <div className="min-h-screen bg-gradient-to-b from-[#0F0B1A] to-[#1A1528] flex items-center justify-center p-4">
        <div className="bg-[#1A1528] rounded-2xl max-w-md w-full p-6 border border-[#F4D03F]/20 shadow-2xl">
          ...
          <div className="space-y-3">
            <button onClick={() => setShowTermsModal(true)} className="w-full py-3.5 rounded-xl bg-white/10 border border-white/20 text-white font-medium flex items-center justify-center gap-2 hover:bg-white/20 transition"><FileText size={18} /> 📖 Ler Termos de Uso</button>
            <button onClick={() => setShowPrivacyModal(true)} className="w-full py-3.5 rounded-xl bg-white/10 border border-white/20 text-white font-medium flex items-center justify-center gap-2 hover:bg-white/20 transition"><Lock size={18} /> 🔒 Ler Política de Privacidade</button>
            <button onClick={handleAcceptTerms} className="w-full py-3.5 rounded-xl bg-gradient-to-r from-[#F4D03F] to-[#FFD966] text-black font-bold flex items-center justify-center gap-2 mt-4"><CheckCircle size={18} /> ✅ ACEITAR E CONTINUAR</button>
          </div>
        </div>
      </div>
    );
      ...
      <div className="max-w-md mx-auto px-4 pb-24 pt-4">
        <div className="bg-gradient-to-br from-[#1A1528] to-[#2D2342] rounded-2xl p-5 border-2 border-[#F4D03F]/30 shadow-xl">
          <div className="relative">
            <div className="w-24 h-24 mx-auto rounded-full bg-gradient-to-br from-[#F4D03F]/30 to-[#8B5CF6]/20 flex items-center justify-center border-2 border-[#F4D03F]/50 shadow-lg">
              <User size={44} className="text-[#F4D03F]" />
            </div>
            <button className="absolute bottom-0 right-1/3 bg-[#F4D03F] rounded-full p-2 shadow-lg hover:scale-105 transition">
          ...
          <div className="text-center mt-4">
            {isEditing ? (
              <div className="space-y-3">
                <input type="text" value={editData.nome_completo} onChange={(e) => setEditData({ ...editData, nome_completo: e.target.value })} className="w-full p-3 rounded-xl bg-white/10 border border-white/15 text-white text-center text-base focus:border-[#F4D03F] outline-none" placeholder="Nome completo" />
                <input type="tel" value={editData.telefone} onChange={(e) => setEditData({ ...editData, telefone: e.target.value })} className="w-full p-3 rounded-xl bg-white/10 border border-white/15 text-white text-center text-base focus:border-[#F4D03F] outline-none" placeholder="Telefone" />
                <div className="flex gap-3 mt-3">
                  <button onClick={handleUpdateProfile} className="flex-1 py-2.5 rounded-xl bg-green-500 text-white text-sm font-bold flex items-center justify-center gap-2"><Save size={16} /> Salvar</button>
                  <button onClick={() => setIsEditing(false)} className="flex-1 py-2.5 rounded-xl bg-red-500/20 text-red-400 text-sm font-bold flex items-center justify-center gap-2"><X size={16} /> Cancelar</button>
                </div>
              </div>
            ) : (
              <>
                ...
                {profile?.telefone && <p className="text-[#A0A0B0] text-xs flex items-center justify-center gap-1 mt-0.5"><Phone size={12} /> {profile.telefone}</p>}
                ...
                <button onClick={() => setIsEditing(true)} className="mt-3 text-[#F4D03F] text-xs flex items-center justify-center gap-1 w-full hover:underline transition"><Edit size={12} /> Editar perfil</button>
              </>
            )}
          </div>
        </div>
        ...
        <div className="mt-5">
          ...
          <div className="grid grid-cols-2 gap-2 mt-2">
            <div className="bg-[#1A1528] rounded-xl p-2 text-center border border-[#F4D03F]/15">
              <div className="flex items-center justify-center gap-1"><Clock size={12} className="text-[#F4D03F]" /><span className="text-white text-sm font-bold">{estatisticas.tempo_medio} min</span></div>
              <p className="text-[#A0A0B0] text-[9px]">Tempo médio</p>
            </div>
            <div className="bg-[#1A1528] rounded-xl p-2 text-center border border-[#F4D03F]/15">
              <div className="flex items-center justify-center gap-1"><TrendingUp size={12} className="text-[#F4D03F]" /><span className="text-white text-sm font-bold">R$ {estatisticas.economizado}</span></div>
        ...
        <div className="mt-5 bg-[#1A1528] rounded-xl border border-[#F4D03F]/15 overflow-hidden">
          <div className="p-3 border-b border-white/10 bg-[#F4D03F]/5"><p className="text-[#F4D03F] text-xs font-bold">⚙️ CONFIGURAÇÕES</p></div>
          <button onClick={() => setIsEditing(true)} className="w-full flex items-center justify-between p-3.5 hover:bg-white/5 transition border-b border-white/10">
            <div className="flex items-center gap-3"><Edit size={18} className="text-[#F4D03F]" /><span className="text-white text-sm">Editar perfil</span></div><ChevronRight size={16} className="text-gray-500" />
          </button>
          <button className="w-full flex items-center justify-between p-3.5 hover:bg-white/5 transition border-b border-white/10">
            <div className="flex items-center gap-3"><CreditCard size={18} className="text-[#F4D03F]" /><span className="text-white text-sm">Formas de pagamento</span></div><ChevronRight size={16} className="text-gray-500" />
          </button>
          <button onClick={() => setActiveMenu('historico')} className="w-full flex items-center justify-between p-3.5 hover:bg-white/5 transition border-b border-white/10">
            <div className="flex items-center gap-3"><History size={18} className="text-[#F4D03F]" /><span className="text-white text-sm">Histórico de corridas</span></div><ChevronRight size={16} className="text-gray-500" />
          </button>
          <button onClick={() => setActiveMenu('favoritos')} className="w-full flex items-center justify-between p-3.5 hover:bg-white/5 transition border-b border-white/10">
            <div className="flex items-center gap-3"><Heart size={18} className="text-[#F4D03F]" /><span className="text-white text-sm">Endereços favoritos</span></div><ChevronRight size={16} className="text-gray-500" />
          </button>

          <div className="p-3 border-b border-white/10 bg-[#F4D03F]/5"><p className="text-[#F4D03F] text-xs font-bold">📜 LEGAL</p></div>
          <button onClick={() => setShowTermsModal(true)} className="w-full flex items-center justify-between p-3.5 hover:bg-white/5 transition border-b border-white/10">
            <div className="flex items-center gap-3"><FileText size={18} className="text-[#F4D03F]" /><span className="text-white text-sm">Termos de Uso</span></div><ChevronRight size={16} className="text-gray-500" />
          </button>
          <button onClick={() => setShowPrivacyModal(true)} className="w-full flex items-center justify-between p-3.5 hover:bg-white/5 transition border-b border-white/10">
            <div className="flex items-center gap-3"><Lock size={18} className="text-[#F4D03F]" /><span className="text-white text-sm">Política de Privacidade</span></div><ChevronRight size={16} className="text-gray-500" />
          </button>

          <div className="p-3 border-b border-white/10 bg-[#F4D03F]/5"><p className="text-[#F4D03F] text-xs font-bold">🔔 PREFERÊNCIAS</p></div>
          <button className="w-full flex items-center justify-between p-3.5 hover:bg-white/5 transition border-b border-white/10">
            <div className="flex items-center gap-3"><Bell size={18} className="text-[#F4D03F]" /><span className="text-white text-sm">Notificações</span></div><ChevronRight size={16} className="text-gray-500" />
          </button>
          <button className="w-full flex items-center justify-between p-3.5 hover:bg-white/5 transition border-b border-white/10">
            <div className="flex items-center gap-3"><Globe size={18} className="text-[#F4D03F]" /><span className="text-white text-sm">Idioma</span></div><ChevronRight size={16} className="text-gray-500" />
          </button>
          <button className="w-full flex items-center justify-between p-3.5 hover:bg-white/5 transition border-b border-white/10">
            <div className="flex items-center gap-3"><Moon size={18} className="text-[#F4D03F]" /><span className="text-white text-sm">Tema escuro</span></div><ChevronRight size={16} className="text-gray-500" />
          </button>

          <div className="p-3 border-b border-white/10 bg-[#F4D03F]/5"><p className="text-[#F4D03F] text-xs font-bold">🛡️ SEGURANÇA E AJUDA</p></div>
          <button className="w-full flex items-center justify-between p-3.5 hover:bg-white/5 transition border-b border-white/10">
            <div className="flex items-center gap-3"><Shield size={18} className="text-[#F4D03F]" /><span className="text-white text-sm">Central de segurança</span></div><ChevronRight size={16} className="text-gray-500" />
          </button>
          <button className="w-full flex items-center justify-between p-3.5 hover:bg-white/5 transition border-b border-white/10">
            <div className="flex items-center gap-3"><HelpCircle size={18} className="text-[#F4D03F]" /><span className="text-white text-sm">Central de ajuda</span></div><ChevronRight size={16} className="text-gray-500" />
          </button>
          <button className="w-full flex items-center justify-between p-3.5 hover:bg-white/5 transition border-b border-white/10">
            <div className="flex items-center gap-3"><MessageCircle size={18} className="text-[#F4D03F]" /><span className="text-white text-sm">Fale conosco</span></div><ChevronRight size={16} className="text-gray-500" />
          </button>
          ...
          <button onClick={onSejaMotorista} className="w-full flex items-center justify-between p-3.5 hover:bg-white/5 transition border-b border-white/10">
            <div className="flex items-center gap-3"><Truck size={18} className="text-[#F4D03F]" /><span className="text-white text-sm">Seja Motorista</span></div><ChevronRight size={16} className="text-gray-500" />
          </button>
          <button className="w-full flex items-center justify-between p-3.5 hover:bg-white/5 transition border-b border-white/10">
            <div className="flex items-center gap-3"><Share2 size={18} className="text-[#F4D03F]" /><span className="text-white text-sm">Convidar amigos</span></div><ChevronRight size={16} className="text-gray-500" />
          </button>

          <button onClick={onLogout} className="w-full flex items-center justify-between p-3.5 hover:bg-red-500/10 transition border-t border-white/10">
            <div className="flex items-center gap-3"><LogOut size={18} className="text-red-400" /><span className="text-red-400 text-sm font-medium">Sair da conta</span></div><ChevronRight size={16} className="text-red-400" />
          </button>
        </div>
