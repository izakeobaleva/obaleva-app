...
import { solicitarCorrida, buscarCorridaAtiva, subscribeToRide, cancelarCorrida, Location, Ride } from '../services/rideService';
...
export function HomeContent({ user, onSignOut }: HomeContentProps) {
  ...
  return (
    <div className="max-w-md mx-auto px-3 pb-28">
      ...
      <div className="bg-[#1A1528] rounded-xl p-4 border border-[#F4D03F]/20 shadow-lg">
        ...
        <button onClick={() => { const temp = pickupAddress; setPickupAddress(dropoffAddress); setDropoffAddress(temp); }} className="mt-3 w-full text-center text-sm text-[#A0A0B0] hover:text-[#F4D03F] transition py-1.5 font-medium">
