...
import { Home, Search, User, Clock, DollarSign, LogOut } from 'lucide-react'
...
export function BottomNav({ role }: BottomNavProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 flex justify-center pb-3 bg-gradient-to-t from-[#0F0B1A] to-transparent pt-3">
