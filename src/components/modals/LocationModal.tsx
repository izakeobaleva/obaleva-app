      ...
      <div className="bg-[#1A1528] w-full max-w-md rounded-t-2xl border-t border-[#F4D03F]/30 max-h-[300px]">
        ...
        <div className="px-5 pb-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h2 className="text-white text-lg font-bold">Permitir acesso à localização?</h2>
          </div>
          <p className="text-[#A0A0B0] text-sm mb-3">Para assegurar que o aplicativo possa enviar corridas e planejar rotas.</p>
          <div className="space-y-1.5">
            <button onClick={() => onAllow('exact')} className="w-full py-1.5 px-4 rounded-xl bg-[#F4D03F] text-black font-bold text-left flex justify-between items-center">
              ...
              <span className="text-[11px] text-black/70 font-normal">DURANTE O USO DO APP</span>
            </button>
            <button onClick={() => onAllow('approximate')} className="w-full py-1.5 px-4 rounded-xl border border-white/20 text-white font-bold text-left flex justify-between items-center">
              ...
              <span className="text-[11px] text-[#A0A0B0] font-normal">APENAS ESTA VEZ</span>
            </button>
            <button onClick={onDeny} className="w-full py-1.5 px-4 rounded-xl text-[#A0A0B0] text-left text-base">🚫 NÃO PERMITIR</button>
          </div>
        </div>
      </div>
    </div>
